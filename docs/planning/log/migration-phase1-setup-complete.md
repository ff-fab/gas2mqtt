...
- `packages/src/gas2mqtt/adapters/hmc5883l.py` — production I2C adapter (HMC5883L)
...
- `Hmc5883lAdapter` — production I2C adapter with `_to_signed_16()` helper
...
- Implement Hmc5883lAdapter (production I2C) and FakeMagnetometer (test double)
